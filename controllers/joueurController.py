...
class JoueurController:
    ...
    def modifier(self):
        prenom = self.joueur_view.get_input(self, "le prénom",
                                          "joueur à modifier")
        nom = self.joueur_view.get_input(self, "le nom",
                                       "joueur à modifier")
        result = None
    ...
    def saisie_modif(self, jr):
        prenom1 = self.joueur_view.get_input(self, "le nouveau prénom",
                                           "joueur")
        nom1 = self.joueur_view.get_input(self, "le nouveau nom",
                                        "joueur")
        date_naiss = self.joueur_view.get_input(self, "la nouvelle date "
                                                    "de naissance", "joueur")
    ...
    def update_joueur(self, joueur: Joueur, jr_id: int):
        self.joueurs.update(self.service_joueur.serialize_joueur(joueur),
                            doc_ids=[int(jr_id)])

    def get_joueur_infos(self):
        prenom = self.joueur_view.get_input(self, "le prénom", "joueur")
        nom = self.joueur_view.get_input(self, "le nom", "joueur")
        date_naissance = self.joueur_view.get_date(
            self, "la date de naissance", "joueur")
