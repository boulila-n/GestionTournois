...
class JoueurController:
    ...
    def modifier(self):
        prenom = self.menu_view.get_input(self, "le prénom",
                                          "joueur à modifier")
        nom = self.menu_view.get_input(self, "le nom",
                                       "joueur à modifier")
        result = None
    ...
    def saisie_modif(self, jr):
        prenom1 = self.menu_view.get_input(self, "le nouveau prénom",
                                           "joueur")
        nom1 = self.menu_view.get_input(self, "le nouveau nom",
                                        "joueur")
        date_naiss = self.menu_view.get_input(self, "la nouvelle date "
                                                    "de naissance", "joueur")
    ...
    def get_joueur_infos(self):
        ...
        date_naissance = self.menu_view.get_date(
